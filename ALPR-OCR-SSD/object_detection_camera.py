...
while True:
    try:
        ...
        cv2.putText(image_np, fps_txt, (5, 30), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,255), 1)
        ...
        cap.release()
        cap =  cv2.VideoCapture("rtsp://movilidad:movi_4567@200.0.29.199:554/Streaming/Channels/102")
        print("Reconectado")
        cv2.destroyAllWindows()